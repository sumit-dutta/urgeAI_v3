...
messages.update(dict.fromkeys(["AWCSK", "AWC"], ["Accentuates Arms & Matches Your Color Choices"]))
messages.update(dict.fromkeys(["AASK"], ["Accentuates your Arms & Complements Your Skin Tone"]))
messages.update(dict.fromkeys(["ABSK"], ["Accentuates Bust &  Complements Your Skin Tone"]))
messages.update(dict.fromkeys(["ALSK"], ["Accentuates Legs & Complements Your Skin Tone"]))
messages.update(dict.fromkeys(["AWSK"], ["Accentuates Arms & Complements Your Skin Tone"]))
...
messages.update(dict.fromkeys([""], ["Try Something New"]))
